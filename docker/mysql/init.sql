...
('Admin Foobar', 'adminfoobar@gmail.com', '$2y$10$CgvSM3RjDD2jYkSNcsvUleR.tANp5PicI2pUI68vaqbWSf0Q6t5vC', 'admin', DATE_ADD('2024-01-01', INTERVAL RAND() * (DATEDIFF('2025-12-31', '2024-01-01')) DAY), 'assets/images/person.svg', NULL, NULL, NULL, NULL, NULL, 'gratis'),
-- Profesores
('José Antonio Rodríguez Argueta', 'jara@gmail.com', '$2y$10$CeyLJvuG/7rZDlYitMm1qOIPgmmpyuvSTVuOUqQY1Z11oMoQEY8.u', 'admin', DATE_ADD('2024-01-01', INTERVAL RAND() * (DATEDIFF('2025-12-31', '2024-01-01')) DAY), 'assets/images/person.svg', NULL, NULL, NULL, NULL, NULL, 'gratis'),
('Carlos Azaustre', 'carlosazaustre@gmail.com', '$2y$10$eVsXWsuAzc5/SE4JxTn3buJJonhi.9869U6n1DcRM3Kp4X4KcQDY6', 'profesor', DATE_ADD('2024-01-01', INTERVAL RAND() * (DATEDIFF('2025-12-31', '2024-01-01')) DAY), 'assets/images/team/carlosazaustre.webp', 'carlosazaustre', 'carlosazaustre', 'carlosazaustre/', 'carlosazaustre/', 'JavaScript & Web', 'gratis'),
('Carmen Ansio', 'carmenansio@gmail.com', '$2y$10$eVsXWsuAzc5/SE4JxTn3buJJonhi.9869U6n1DcRM3Kp4X4KcQDY6', 'profesor', DATE_ADD('2024-01-01', INTERVAL RAND() * (DATEDIFF('2025-12-31', '2024-01-01')) DAY), 'assets/images/team/carmenansio.webp', 'carmenansio', 'carmenansio', 'carmenansio/', 'carmenansio/', 'Diseño & Accesibilidad', 'gratis'),
('Carlos Santana Vega', 'dotcsv@gmail.com', '$2y$10$eVsXWsuAzc5/SE4JxTn3buJJonhi.9869U6n1DcRM3Kp4X4KcQDY6', 'profesor', DATE_ADD('2024-01-01', INTERVAL RAND() * (DATEDIFF('2025-12-31', '2024-01-01')) DAY), 'assets/images/team/dotcsv.webp', 'DotCSV', 'dotcsv', 'dotcsv/', 'carlossantanavega/', 'IA & Machine Learning', 'gratis'),
('Miguel Ángel Durán', 'midudev@gmail.com', '$2y$10$eVsXWsuAzc5/SE4JxTn3buJJonhi.9869U6n1DcRM3Kp4X4KcQDY6', 'profesor', DATE_ADD('2024-01-01', INTERVAL RAND() * (DATEDIFF('2025-12-31', '2024-01-01')) DAY), 'assets/images/team/midudev.webp', 'midudev', 'midudev', 'midu.dev/', 'midudev/', 'Web Dev & Comunidad', 'gratis'),
...
(81, 2, 'Proyecto práctico I', 'Actividad guiada para afianzar conceptos del curso.', 'https://www.youtube.com/watch?v=arfDRUIZOiw', 6),
(82, 2, 'Buenas prácticas', 'Patrones, consejos y convenciones recomendadas.', 'https://www.youtube.com/watch?v=WK6u8YDYqak', 7),
(83, 2, 'Optimización y rendimiento', 'Técnicas para mejorar tiempos de carga y uso de recursos.', 'https://www.youtube.com/watch?v=VYFjvMfVv2o', 8),
(84, 2, 'Integración con herramientas externas', 'Cómo conectar el curso con herramientas del ecosistema.', 'https://www.youtube.com/watch?v=vqKie-xmcFs', 9),
(85, 2, 'Proyecto final', 'Implementación completa aplicando todo lo aprendido.', 'https://www.youtube.com/watch?v=cY0XJY98d3w', 10),
(86, 3, 'Proyecto práctico I', 'Actividad guiada para afianzar conceptos del curso.', 'https://www.youtube.com/watch?v=Y6q8R-9y6a0', 6),
(87, 3, 'Buenas prácticas', 'Patrones, consejos y convenciones recomendadas.', 'https://www.youtube.com/watch?v=irfbn103AzE', 7),
(88, 3, 'Optimización y rendimiento', 'Técnicas para mejorar tiempos de carga y uso de recursos.', 'https://www.youtube.com/watch?v=yCCIztB-S_k', 8),
(89, 3, 'Integración con herramientas externas', 'Cómo conectar el curso con herramientas del ecosistema.', 'https://www.youtube.com/watch?v=7AT1X9Z41sA', 9),
(90, 3, 'Proyecto final', 'Implementación completa aplicando todo lo aprendido.', 'https://www.youtube.com/watch?v=NRoET8-8cbw', 10),
...
(96, 5, 'Proyecto práctico I', 'Actividad guiada para afianzar conceptos del curso.', 'https://www.youtube.com/watch?v=lsV8JQgSW1s', 6),
(97, 5, 'Buenas prácticas', 'Patrones, consejos y convenciones recomendadas.', 'https://www.youtube.com/watch?v=s5Lu4QTjeL0', 7),
(98, 5, 'Optimización y rendimiento', 'Técnicas para mejorar tiempos de carga y uso de recursos.', 'https://www.youtube.com/watch?v=W77qmqrhCcA', 8),
(99, 5, 'Integración con herramientas externas', 'Cómo conectar el curso con herramientas del ecosistema.', 'https://www.youtube.com/watch?v=XKyyM1VWtUE', 9),
(100, 5, 'Proyecto final', 'Implementación completa aplicando todo lo aprendido.', 'https://www.youtube.com/watch?v=drEjyBSu33w', 10),
(101, 6, 'Proyecto práctico I', 'Actividad guiada para afianzar conceptos del curso.', 'https://www.youtube.com/watch?v=DZwmZ8Usvnk', 6),
(102, 6, 'Buenas prácticas', 'Patrones, consejos y convenciones recomendadas.', 'https://www.youtube.com/watch?v=6iF8Xb7Z3wQ', 7),
(103, 6, 'Optimización y rendimiento', 'Técnicas para mejorar tiempos de carga y uso de recursos.', 'https://www.youtube.com/watch?v=9Os0o3wzS_I', 8),
(104, 6, 'Integración con herramientas externas', 'Cómo conectar el curso con herramientas del ecosistema.', 'https://www.youtube.com/watch?v=CqvZ3vGoGs0', 9),
(105, 6, 'Proyecto final', 'Implementación completa aplicando todo lo aprendido.', 'https://www.youtube.com/watch?v=tJxcKyFMTGo', 10),
(106, 7, 'Proyecto práctico I', 'Actividad guiada para afianzar conceptos del curso.', 'https://www.youtube.com/watch?v=lT2AvQ17F_w', 6),
(107, 7, 'Buenas prácticas', 'Patrones, consejos y convenciones recomendadas.', 'https://www.youtube.com/watch?v=bWygRxrlD44', 7),
(108, 7, 'Optimización y rendimiento', 'Técnicas para mejorar tiempos de carga y uso de recursos.', 'https://www.youtube.com/watch?v=G1iDSoAXyvM', 8),
(109, 7, 'Integración con herramientas externas', 'Cómo conectar el curso con herramientas del ecosistema.', 'https://www.youtube.com/watch?v=TBUgZ84tTgU', 9),
(110, 7, 'Proyecto final', 'Implementación completa aplicando todo lo aprendido.', 'https://www.youtube.com/watch?v=hxYQA-nuIXY', 10),
...
(116, 9, 'Proyecto práctico I', 'Actividad guiada para afianzar conceptos del curso.', 'https://www.youtube.com/watch?v=N1G5KSEXzDM', 6),
(117, 9, 'Buenas prácticas', 'Patrones, consejos y convenciones recomendadas.', 'https://www.youtube.com/watch?v=nXzBmISJWG0', 7),
(118, 9, 'Optimización y rendimiento', 'Técnicas para mejorar tiempos de carga y uso de recursos.', 'https://www.youtube.com/watch?v=V_xewhxeZvM', 8),
(119, 9, 'Integración con herramientas externas', 'Cómo conectar el curso con herramientas del ecosistema.', 'https://www.youtube.com/watch?v=V_xewhxeZvM', 9),
(120, 9, 'Proyecto final', 'Implementación completa aplicando todo lo aprendido.', 'https://www.youtube.com/watch?v=V_xewhxeZvM', 10),
(121, 10, 'Proyecto práctico I', 'Actividad guiada para afianzar conceptos del curso.', 'https://www.youtube.com/watch?v=T6k7Hs0CYm4', 6),
(122, 10, 'Buenas prácticas', 'Patrones, consejos y convenciones recomendadas.', 'https://www.youtube.com/watch?v=L5HJKX8Fa-I', 7),
(123, 10, 'Optimización y rendimiento', 'Técnicas para mejorar tiempos de carga y uso de recursos.', 'https://www.youtube.com/watch?v=9pm0xmbbHq8', 8),
(124, 10, 'Integración con herramientas externas', 'Cómo conectar el curso con herramientas del ecosistema.', 'https://www.youtube.com/watch?v=yE27t-xqrkc', 9),
(125, 10, 'Proyecto final', 'Implementación completa aplicando todo lo aprendido.', 'https://www.youtube.com/watch?v=OhT_HruW6dM', 10),
